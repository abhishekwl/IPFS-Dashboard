...
import MusicIcon from '../../icons/GlyphDocMusic'
import VideoIcon from '../../icons/GlyphDocMovie'
      ...
      <div className={this.props.className}>
        <Dropdown>
          ...
          <DropdownMenu
            ...
            <Option onClick={() => this.audioInput.click()}>
              <MusicIcon className='fill-aqua w2 mr1' />
              {t('addAudio')}
            </Option>
            <Option onClick={() => this.videoInput.click()}>
              <VideoIcon className='fill-aqua w2 mr1' />
              {t('addVideo')}
            </Option>
        ...
        <input
          ...
          className='dn'
          multiple
          ref={el => { this.audioInput = el }}
          onChange={this.onInputChange(this.audioInput)} />
        ...
        <input
          ...
          onChange={this.onInputChange(this.videoInput)} />
